...
namespace BlockchainAssignment
{
    class Block
    {
        ...
        public Block(Block lastBlock, List<Transaction> transactions, String minerAddress)
        {
            ...
            merkleRoot = MerkleRoot(transactionList); // Calculate the Merkle root of the block's transactions
        ...
        public String CreateHash()
        {
            ...
            /* Concatenate all of the block's properties including nonce as to generate a new hash on each call */
        ...
        // Create reward for incentivizing the mining of block
